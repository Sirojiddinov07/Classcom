...
=======
    ...
    path("auth/register/", views.RegisterView.as_view(), name="register"),  # Register # noqa   DONE
    path("auth/confirm/", views.ConfirmView.as_view(), name="confirm"),  # Confirm Otp code view # noqa DONE
    path("auth/reset/password/", views.ResetPasswordView.as_view(), name="reset-password"),
    # Reset password step 1 # noqa
    path("auth/reset/confirm/", views.ResetConfirmationCodeView.as_view(), name="reset-confirmation-code"),  # noqa done
    path("auth/reset/set/", views.ResetSetPasswordView.as_view(), name="set-password"),  # noqa     DONE

    # Reset password step 2
    path("auth/resend/", views.ResendView.as_view(), name="resend"),  # resend otp code # noqa
    path("auth/me/", views.MeView.as_view(), name="me"),  # get user information # noqa     done
>>>>>>> origin/dev
]
